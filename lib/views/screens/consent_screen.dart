                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Opacity(
                      opacity: .8,
                      child: Text(
                        'To ensure safety for all users and visitors, please make sure your VLag profile adhere to the following conditions. Failure to do so may result in content or/and account ban.',
                        textAlign: TextAlign.center,
                      ),
                    ),
                  ),
                      ...
                      children: [
                        ...
                        ElevatedButton(
                            ...
                            onPressed: _countinueButtonActive
                                ...
                                : null,
                            child: Text('Continue', style: VLagButtonStyle.buttonText)),
                      ],
                    ),
                  )
                ],
